...
class MainDashboardScreen extends StatefulWidget {
  // For 1 send another screeen but 0 stay on MainDashboardScreen screen
            ...
            Container(
                ...
                child: TextButton(
                  style: TextButton.styleFrom(
                    ...
                    disabledBackgroundColor: MyColors.darkGreyColor,
                    textStyle: TextStyle(color: Colors.white),
                    backgroundColor: MyColors.primaryColor,
                  ),
                  child: Text(
    ...
    response.stream.transform(utf8.decoder).listen((value) {
      ...
      if (data['status'] == "success") {
        setState(() {
          ...
          print(data['data']['successScreen']);

          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) =>
                      ThankyouScreen(data['data']['successScreen'])));
          selectedIndex = 0;
          clearAll();
        });
      } else {
